    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('<?= base_url() ?>static/images/index.jpg');" data-stellar-background-ratio="0.5">
      <div class="container">
        ...
        <div class="col-md-12 mt-5 mb-5">
                ...
                <input type="hidden" id="id-url" value='<?= $_GET['id'] ?>'>
                    ...
                    <button id="btn-password" class="btn btn-lg" onclick="actualizarPassword()">Cambiar Contraseña</button>
                    </div>
                    </div>
                    </div>

                    <div id="aviso-div" style="display:none;">
                        <h2>Contraseña actualizada con éxito. Vuelva al inicio de sesión para continuar.</h2>
                    </div>
...
<script src="<?= base_url() ?>static/js/recuperar.js"></script>
