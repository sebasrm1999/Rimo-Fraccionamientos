      ...
      <div class="container">
        ...
        <div class="col-md-12 mt-5 mb-5">
                ...
                <div action="#" class="shadow p-5 bg-white rounded">
                    ...
                    <div id="correo-div" style="display:block;">
                    ...
                    <button id="btn-login" class="btn btn-lg" onclick="mandarCorreo()">Mandar Correo</button>
                    </div>
                    </div>
                    </div>

                    <div id="aviso-div" style="display:none;">
                        <h2>Le hemos enviado un correo electrónico para proceder con el cambio de contraseña.</h2>
                    </div>
...
<script src="<?= base_url() ?>static/js/olvidar.js"></script>
