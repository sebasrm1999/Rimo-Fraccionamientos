...
<div class="super_container">
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<nav class="main_nav">
				<ul class="d-flex flex-row align-items-start justify-content-start">
                    ...
                    <li class="active"><a href="#"><i class="fa fa-cog fa-3x"></i></a></li>
				</ul>
			</nav>
			...
			<div class="row">
				<div class="col-md-10">
					<div class="section_title_container text-center">
						<div class="section_title"><h1>Configuración General</h1></div>
					</div>
				</div>
				<div class="col-md-2">
					<button id="btn-actualizar" class="btn btn-outline-warning"><i class="fa fa-pencil fa-3x"></i></button>
				</div>
			</div>
		</div>

    <div id="form-parametros" action="#" class="mx-5 my-5">
		...
		<div class="row form-group mb-4">
			...
			<label class="font-weight-bold" for="pronto">Primeros días del mes para pronto pago: </label>
            <input id="pronto" type="number" placeholder="Número de días..." name="pronto" disabled required class="form-control">
			<div id="pronto-error"></div>
			</div>

			
			<div class="col-md-4 mb-3 mb-md-0">
				<label class="font-weight-bold" for="costo">Costo mensualidad: </label>
				<input type="text" id="costo" class="form-control" disabled required>
				<div id="costo-error"></div>
			</div>

			<div class="col-md-4 mb-3 mb-md-0">
				<label class="font-weight-bold" for="costo-pronto">Costo mensualidad con pronto pago: </label>
				<input type="text" id="costo-pronto" class="form-control" disabled required>
				<div id="costo-pronto-error"></div>
			</div>
		...
		<div class="row form-group mb-4">
			...
			<div class="col-md-4 mb-3 mb-md-0">
				...
				<select class="form-control" id="banco" disabled required>
					<option value="santander">Santander</option>
					<option value="bancomer">Bancomer</option>
					<option value="banamex">Banamex</option>
					<option value="hsbc">HSBC</option>
				</select>
				<div id="banco-error"></div>
			</div>
			

			<div class="col-md-8 mb-3 mb-md-0">
				<label class="font-weight-bold" for="numero">Número de cuenta a la que se harán los pagos: </label>
				<input type="text" id="numero" class="form-control" disabled required maxlength="16">
		...
		<div class="col-md-12 mb-3 mb-md-0">
			<label class="font-weight-bold" for="clabe">CLABE Interbancaria</label>
			<input type="text" id="clabe" class="form-control" disabled required maxlength="18">
			<div id="clabe-error"></div>
		</div>
		
		</div>

        <button id="btn-confirmar" style="display: none;" type="button" class="subscribe btn btn-confirmar btn-block rounded-pill shadow-sm" onclick="actualizardatos()"> Confirmar  </button>
        </form>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
      <h4 id="info-modal-titulo" class="modal-title text-white">Alerta</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<script src="<?= base_url() ?>static/js/parametrosCrud.js"></script>
</body>
</html>