...
<div class="super_container">
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<div class="section_title"><h1>Áreas</h1></div>
					</div>
				</div>
			</div>
    ...
    <button id="btn-nuevo-area" class="btn p-2 px-4 text-white btn-quejas">
    <div class="row">
        <i class="fa fa-plus fa-3x mr-2"></i><h3 class="text-white mt-2">Nuevo área</h3>
    </div>    
    </button>
    </div>

    <div id="form-area" action="#" class="mx-5 my-5" style="display: none;">
...
<script src="<?= base_url() ?>static/js/areasCrud.js"></script>
</body>
</html>